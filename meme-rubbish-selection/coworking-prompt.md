...
* **Current Equity**: **300 U**
* **Stage 1 (Validation)**: [✅ COMPLETED]
* **Stage 2 (Deployment)**: [🔥 CURRENT ACTIVE]
* **Hard Cap**: **15 U** (10% of Equity).
* **Dynamic Sizing**:
* *High Conviction + Thick Depth*: 20 - 30 U.
* *High Volatility / Thin Depth*: 6 - 10 U (Risk Dampening).




* **Stage 3 (Harvest)**: [LOCKED]
* *Trigger*: Equity doubles to 600 U.
* *Cap*: 30% Equity (Max 180 U).
